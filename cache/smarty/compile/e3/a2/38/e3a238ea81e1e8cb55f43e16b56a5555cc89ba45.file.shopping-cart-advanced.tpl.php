<?php /* Smarty version Smarty-3.1.19, created on 2015-08-18 14:21:17
         compiled from "/Applications/MAMP/htdocs/prestashop/themes/default-bootstrap/shopping-cart-advanced.tpl" */ ?>
<?php /*%%SmartyHeaderCode:123883057955d3233d01f545-92317549%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e3a238ea81e1e8cb55f43e16b56a5555cc89ba45' => 
    array (
      0 => '/Applications/MAMP/htdocs/prestashop/themes/default-bootstrap/shopping-cart-advanced.tpl',
      1 => 1436343200,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '123883057955d3233d01f545-92317549',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55d3233dc71359_54901311',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55d3233dc71359_54901311')) {function content_55d3233dc71359_54901311($_smarty_tpl) {?>
<h2><?php echo smartyTranslate(array('s'=>'Cart Summary'),$_smarty_tpl);?>
</h2>
<?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['total_discounts']->value!=0) {?><?php echo "1";?><?php } else { ?><?php echo "0";?><?php }?><?php $_tmp22=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['total_discounts_num'] = new Smarty_variable($_tmp22, null, 0);?>
<?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['use_taxes']->value&&$_smarty_tpl->tpl_vars['show_taxes']->value) {?><?php echo "2";?><?php } else { ?><?php echo "0";?><?php }?><?php $_tmp23=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['use_show_taxes'] = new Smarty_variable($_tmp23, null, 0);?>
<?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['total_wrapping']->value!=0) {?><?php echo "1";?><?php } else { ?><?php echo "0";?><?php }?><?php $_tmp24=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['total_wrapping_taxes_num'] = new Smarty_variable($_tmp24, null, 0);?>
...
?>
            ...
            <?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['tpl_dir']->value)."./shopping-cart-product-line.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('productLast'=>$_smarty_tpl->tpl_vars['product']->last,'productFirst'=>$_smarty_tpl->tpl_vars['product']->first,'noDeleteButton'=>1,'cannotModify'=>1), 0);?>
...
<?php }?></span>
                ...
                <?php if ($_smarty_tpl->tpl_vars['product']->value['quantity']-$_smarty_tpl->tpl_vars['quantityDisplayed']->value>0) {?><?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['tpl_dir']->value)."./shopping-cart-product-line.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('productLast'=>$_smarty_tpl->tpl_vars['product']->last,'productFirst'=>$_smarty_tpl->tpl_vars['product']->first,'noDeleteButton'=>1,'cannotModify'=>1), 0);?>
<?php }?>
            <?php }?>
        <?php } ?>
