<?php /* Smarty version Smarty-3.1.19, created on 2015-08-18 14:48:40
         compiled from "/Applications/MAMP/htdocs/prestashop/admin971f3dilz/themes/default/template/controllers/customers/helpers/list/list_header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:67764797855d329a84985d6-54272396%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3689db13628f2120d9d9aa4ad77539c1eb3aeaff' => 
    array (
      0 => '/Applications/MAMP/htdocs/prestashop/admin971f3dilz/themes/default/template/controllers/customers/helpers/list/list_header.tpl',
      1 => 1436343200,
      2 => 'file',
    ),
    '3281cc9482679e9b3d8ce4227496f5dcb1f35a1a' => 
    array (
      0 => '/Applications/MAMP/htdocs/prestashop/admin971f3dilz/themes/default/template/helpers/list/list_header.tpl',
      1 => 1436343200,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '67764797855d329a84985d6-54272396',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55d329a90e2400_26675786',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55d329a90e2400_26675786')) {function content_55d329a90e2400_26675786($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/Applications/MAMP/htdocs/prestashop/tools/smarty/plugins/function.math.php';
?>
				...
				<ul class="listForm list-unstyled">
					<li>
						<label for="deleteMode_real" class="control-label">
							...
							<?php echo smartyTranslate(array('s'=>'I want my customers to be able to register again with the same email address. All data will be removed from the database.'),$_smarty_tpl);?>
...
" <?php }?>>
							...
							<?php } else { ?>
								<?php if ($_smarty_tpl->tpl_vars['params']->value['type']=='bool') {?>
									<select class="filter fixed-width-sm" name="<?php echo $_smarty_tpl->tpl_vars['list_id']->value;?>
...
_1").datepicker("setDate", dateEnd);
								...
								<?php } elseif ($_smarty_tpl->tpl_vars['params']->value['type']=='select') {?>
									<?php if (isset($_smarty_tpl->tpl_vars['params']->value['filter_key'])) {?>
										<select class="filter" onchange="$('#submitFilterButton<?php echo $_smarty_tpl->tpl_vars['list_id']->value;?>
